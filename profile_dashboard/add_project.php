...
if(isset($_POST['project-name'])&&isset($_SESSION))
{

    $uid = $_SESSION["uid"];
    $query="SELECT name FROM projects WHERE uid = $uid;";
    ...
    if($num<=5)
    {
        ...
        $query="INSERT INTO projects(uid,name,description,repo) VALUES('$uid','$name','$description','$repo')";
        $result=mysqli_query($conn,$query);
    ...
    {
        echo "<h1 style='text-align:center;color:white;'>Max Projects</h1>";
        exit();
    }
}
