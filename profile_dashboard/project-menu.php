...
<body>
    <div class="update-profile">
        <form>
            ...
            <div class="form-group">
                <a type="button" href="add-project.php" class="btn btn-block update-account">Project 1</a>
            </div>
            <div class="form-group">
                <a type="button" href="add-project.php" class="btn btn-block update-account">Project 2</a>
            </div>
            <div class="form-group">
                <a type="button" href="add-project.php" class="btn btn-block update-account">Project 3</a>
            </div>
            <div class="form-group">
                <a type="button" href="add-project.php" class="btn btn-block update-account">Project 4</a>
            </div>
            <div class="form-group">
                <a type="button" href="add-project.php" class="btn btn-block update-account">Project 5</a>
            </div>
        </form>
    </div>
