...
<body>
    <div class="update-profile">
        <form>
            ...
            <p class="warning">*Add Skills</p>
            <?php
            foreach($skills as $skill)
            {
            ?>
            <div class="form-group">
                <a type="button" href="manage_skill.php/?skill_id=<?php echo $skill['skill_id'];?>" class="btn btn-block update-account"><?php echo $skill['name'];?></a>
            </div>
            <?php
            }
            ?>
            <div class="form-group">
                <a type="button" href="add-skill.php" class="btn btn-block update-account">Add Skill</a>
            </div>
        </form>
    </div>
